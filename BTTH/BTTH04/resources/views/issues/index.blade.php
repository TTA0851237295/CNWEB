				...
				<tbody>
                    @foreach ($issues as $issue)
                        <tr>
                            ...
                            <td>{{ $issue->status }}</td>
                            <td>
                                <a href="{{ route('issues.edit', $issue->id) }}" class="edit" data-toggle="tooltip" title="Sửa">
                                    <i class="material-icons">edit</i>
                                </a>
                                <!-- Nút xóa kèm modal xác nhận -->
                                <a href="#" class="delete" data-toggle="modal" data-target="#deleteModal{{ $issue->id }}" title="Xóa">
